...
# MAGIC Create assets on TARGET in dependency order from the bundle. Dry-run default; idempotent + checkpointed. Builds identity_map + remaps ACLs. STUB.
# MAGIC
...
raise NotImplementedError("04 — Import (TARGET side): stub — implement after PLAN_1 approval")
