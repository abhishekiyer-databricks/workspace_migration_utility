...
# MAGIC %md
# MAGIC # 00 — Main Orchestrator (TARGET side)
# MAGIC Optional orchestrator: runs 00_Account_Preflight → 03_Transform_Review → 04_Import → 05_Validate in the TARGET workspace. STUB.
# MAGIC
...
raise NotImplementedError("00 — Main Orchestrator (TARGET side): stub — implement after PLAN_1 approval")
