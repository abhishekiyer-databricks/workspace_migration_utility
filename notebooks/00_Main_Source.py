...
# MAGIC %md
# MAGIC # 00 — Main Orchestrator (SOURCE side)
# MAGIC Optional orchestrator: runs 01_Inventory → 02_Export in the SOURCE workspace, passing shared run_id + widgets. STUB.
# MAGIC
...
raise NotImplementedError("00 — Main Orchestrator (SOURCE side): stub — implement after PLAN_1 approval")
