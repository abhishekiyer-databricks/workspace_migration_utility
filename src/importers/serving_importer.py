"""
ServingImporter — writes serving to the TARGET workspace.

STUB ONLY (see PLAN.md §6 asset catalog, §2). Create model serving endpoints from served_entities/traffic config.
