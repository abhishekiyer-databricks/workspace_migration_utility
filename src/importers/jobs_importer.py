"""
JobsImporter — writes jobs to the TARGET workspace.

STUB ONLY (see PLAN.md §6 asset catalog, §2). Create jobs; remap cluster/pool/policy/notebook-path/run-as; pause schedules per toggle.
