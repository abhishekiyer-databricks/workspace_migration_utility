"""
ComputeImporter — writes compute to the TARGET workspace.

STUB ONLY (see PLAN.md §6 asset catalog, §2). Instance pools -> policies -> clusters, remapping pool/policy ids.
