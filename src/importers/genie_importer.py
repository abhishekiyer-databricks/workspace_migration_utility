"""
GenieImporter — writes genie to the TARGET workspace.

STUB ONLY (see PLAN.md §6 asset catalog, §2). Genie auto-create blocked by API -> resolve warehouse ids + emit manual recreation instructions.
